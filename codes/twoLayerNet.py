...
class FCN(torch.nn.Module): 
    ...
    def __init__(self):
        ...
        self.firstlayer = torch.nn.Sequential(
            torch.nn.Conv2d(1,18,(9,7),padding=(9//2,7//2),stride=(1,100)),
            torch.nn.BatchNorm2d(18),
            torch.nn.ReLU(True),
            torch.nn.Conv2d(18,30,(5,1),padding=(5//2,1//2),stride=(1,100)),
            torch.nn.BatchNorm2d(30),
            torch.nn.ReLU(True),
            torch.nn.Conv2d(30,8,(9,1),padding=(9//2,1//2),stride=(1,100)),
            torch.nn.BatchNorm2d(8),
            torch.nn.ReLU(True)
        )
        self.hiddenlayer = torch.nn.Sequential(
            torch.nn.Conv2d(8,18,(9,1),padding=(9//2,1//2),stride=(1,100)),
            torch.nn.BatchNorm2d(18),
            torch.nn.ReLU(True),
            torch.nn.Conv2d(18,30,(5,1),padding=(5//2,1//2),stride=(1,100)),
            torch.nn.BatchNorm2d(30),
        ...
        self.lastlayer = torch.nn.Conv2d(8,1,(129,1),padding=(129//2,1//2),stride=(1,100))
